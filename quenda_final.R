...
# ---------------------------
player_df <- fb_player_scouting_report("https://fbref.com/en/players/19f53b56/Geovany-Quenda", pos_versus = "primary")
...
ggplot(df_metrics, aes(fct_reorder(Statistic, stat), Percentile)) +                       
  ...
  labs(fill="", 
       ...
       title = glue("{df_metrics$Player[1]} | Sporting CP"), 
  ...
  ggsave("quenda_chart.png", width = 10, height = 10, dpi = 300)
